...
const projectName = 'Reverse-clock';
...
class Timer extends React.Component {
  ...
  phaseControl() {
    ...
    if (timer < 0) {
      ...
      if (this.state.timerType === 'Session') {
        this.beginCountDown();
        this.switchTimer(this.state.timer * 60, 'Break');
      } else {
        this.beginCountDown();
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "main-title" }, "Reverse Clock"), /*#__PURE__*/
      ...
      React.createElement("a", { href: "https://codepen.io/bayrem-ben", target: "_blank" }, "Bayrem Ben Abdallah")), /*#__PURE__*/
